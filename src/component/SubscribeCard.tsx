const SubscribeCard= () => {
  return (
    <div className='bg-primarydark relative w-[85vw] md:w-[75vw] mx-auto h-[50vh] md:h-96 flex flex-col justify-center items-center rounded-2xl text-white my-16'>
      ...
      <a href='https://discord.com/' target='_blank' className='w-72 md:w-96 bg-white shadow-md hover:border-[1px] text-center border-primarydark py-2 md:py-2 rounded-md absolute text-black mt-44'>JOIN DISCORD</a>
      </div>
    </div>
  )
}
